...
/**
 * Represents a single component in a Place's full address. For example, the
 * address "111 8th Avenue, New York, NY" contains separate address components
 * for "111" (the street number, "8th Avenue" (the route), "New York" (the city)
 * and "NY" (the US state).
 */
public class AddressComponent
{
	...
	/**
	 * Sets the short name of the component. For example, "New York" might be
	 * abbreviated as "NY".
	 * 
	 * @param shortName
	 *            of component
	...
	/**
	 * Returns the short name of the component. For example, "New York" might be
	 * abbreviated as "NY".
	 * 
	 * @return short name
	 */
