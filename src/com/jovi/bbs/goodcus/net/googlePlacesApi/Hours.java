...
public class Hours
{
	 ...
	 * 
	 * @param alwaysOpened
	 *            if this place is always opened
	 * @return this
	 */
	...
	public static class Period
	{
		...
		/**
		 * Sets the time this period opens. This should be provided in an hhmm
		 * format.
		 * 
		 * @param openingTime
		 *            starting time
		...
		{
			return String.format("%s %s:%s -- %s %s:%s", openingDay, openingTime.substring(0, 2), openingTime.substring(2), closingDay,
					closingTime.substring(0, 2), closingTime.substring(2));
		}
	}
